# Starter MySQL implementation contract

This repository owns the independently versioned MySQL integration for
...
The normal gate is offline after dependencies are cached. Docker-backed MySQL
acceptance is an additional release and hosted integration gate; it
