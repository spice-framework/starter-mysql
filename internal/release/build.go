// Package release builds deterministic, signed starter-mysql source releases.
package release
...
func Build(ctx context.Context, config Config) (result Result, resultErr error) {
	...
	staging, err := os.MkdirTemp(parent, ".starter-mysql-release-*")
	if err != nil {
...
func sourceEntries(ctx context.Context, root, version string) ([]archiveEntry, error) {
	...
	prefix := "starter-mysql-" + strings.TrimPrefix(version, "v")
